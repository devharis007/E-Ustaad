            ...
            <div className="row mt-3">
              ...
              <div className="col-lg-3 col-xl-3  B1 mt-3">
                ...
                <p className="color-black ">
                  E-Ustaad is the E-learning platform Since 2021 . E-Ustaad is
                  the platform for students and teachers where both connect with
                  each other to learn more and earn more
                </p>
              </div>
              ...
              <div className="col-md-4 col-lg-4 col-xl-3 mx-auto mb-md-0 mb-4 color-black-bold mt-3 M1 ">
                <h6 className="text-uppercase fw-bold mb-4">Contact </h6>
                <p className="color-black">
                  <FontAwesomeIcon icon={faHome} className="margin-r" />{" "}
                  Valenica, Lahore, Punjab
                </p>
                <p>
                ...
                <p className="color-black">
                  <FontAwesomeIcon icon={faPhone} className="margin-r" /> + 92
                  306 4526 821
                </p>
              </div>
            </div>
